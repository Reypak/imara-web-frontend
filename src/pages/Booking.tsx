  ...
  const steps = [
    {
      ...
      desc: "Select the service and your preferred date and time.",
    },
    {
      n: "02",
      title: "Your Details",
      desc: "Fill in your contact info so we can confirm your slot.",
    },
    {
      n: "03",
      title: "Confirmation",
      desc: "We'll call you within 2 hours to confirm the booking.",
    },
  ];
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse at 30% 50%, rgba(201,168,76,0.07) 0%, transparent 65%)",
            pointerEvents: "none",
          }}
        />
        <div className="container relative z-10">
          ...
          >
            ...
            >
              Book Your
              <br />
              <span className="gold-text">Session</span>
            </h1>
          </motion.div>
        </div>
      </section>
            ...
            >
              {submitted ? (
                ...
                >
                  ...
                  >
                    Thank you, {formData.name}. We'll call you within 2 hours to
                ...
                >
                  ...
                  >
                    We recommend booking at least 24 hours in advance. For
                    same-day, call us directly.
                  </p>
                </form>
              )}
            </motion.div>
